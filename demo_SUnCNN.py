...
#%% 替换数据即可
fname2  = "ADSU_Data/DC1/image_20db.mat"
mat2 = scipy.io.loadmat(fname2)
img_np_gt = mat2["Image_20db"]
...
for fi in tqdm(range(tol1)):
    ...
    if  save_result is True:
         scipy.io.savemat(r"D:\work\TGRS\data\adsu_lambda\DC1\x_20db_SUnCNN.mat" % (fi+2,1),
